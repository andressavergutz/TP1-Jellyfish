...
class NXTopology:
    ...
    def __init__(self, number_of_servers=686, switch_graph_degree=16, number_of_links=3000, labels=['k_shortest path', '8-way-ECMP', '64-way-ECMP']):
        self.number_of_servers = number_of_servers
        self.switch_graph_degree = switch_graph_degree  # k
        self.number_of_racks = (2 * number_of_links) // self.switch_graph_degree
        self.number_links = number_of_links
    ...
    def calculate_all_paths(self):
        for sender in range(len(self.sender_to_receiver)):
            ...
            self.add_to_edge_label(k_shortest_paths, 'k_shortest path')
            self.add_to_edge_label(ecmp8, '8-way-ECMP')
            self.add_to_edge_label(ecmp64, '64-way-ECMP')
    ...
    def draw_fig9(self, y_axes):
        ...
        plt.ylim(0, m + 1)
        plt.xlim(0, self.number_links)
        plt.title("Figure 9 Replication (686 Servers)")
...
if __name__ == "__main__":
    ...
    y_axes = {'k_shortest path':t.to_y_axis('k_shortest path'), '8-way-ECMP':t.to_y_axis('8-way-ECMP'), '64-way-ECMP': t.to_y_axis('64-way-ECMP')}
    # print(y_axes)
    t.draw_fig9(y_axes)
